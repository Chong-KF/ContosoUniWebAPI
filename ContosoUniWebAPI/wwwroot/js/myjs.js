var API = "http://localhost:53377/api/";

function ButtonEdit(link) {
    ...
    var s = "<button class='btn btn-sm' style='background-color:transparent;' title='Edit'";
    s += "onclick = '" + link + "'>" + svg + "</button>";
    return s;
}

function ButtonDel(link) {
    ...
    var s = "<button class='btn btn-sm' style='background-color:transparent;' title='Delete'";
    s += "onclick = '" + link + "'>" + svg + "</button>";
    return s;
}

function ButtonDetails(link) {
    ...
    var s = "<a href='" + link + "' class='btn btn-sm' style='background-color:transparent;' title='Details' role='button'>" + svg + "</a>";
    return s;
}

function ButtonOK(id, link) {
    ...
    var s = "<button id='" + id + "' class='btn btn-sm' style='background-color:transparent;' title='Proceed'";
    s += "onclick = '" + link + "'>" + svg + "</button>";
    return s;
}

function ButtonCancel(link) {
    var svg = "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-x-square' viewBox='0 0 16 16'><path d='M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z'/><path d='M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z'/></svg>";
    var s = "<button class='btn btn-sm' style='background-color:transparent;' title='Cancel'";
    s += "onclick = '" + link + "'>" + svg + "</button>";
    return s;
}
...
function ButtonAdd(link) {
    ...
    var s = "<button class='btn btn-sm' style='background-color:transparent;' title='Add'";
    s += "onclick = '" + link + "'>" + svg + "</button>";
    return s;
}